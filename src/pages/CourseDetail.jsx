      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        ...
        <section className="mb-6 sm:mb-8">
          ...
          {program.specialization && (
            <p className="text-lg sm:text-xl text-gray-700 mb-3 sm:mb-4">Specialization: {program.specialization}</p>
          )}
        ...
        <section className="mb-6 sm:mb-8 bg-gray-50 p-4 sm:p-6 rounded-lg">
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Program Overview</h2>
        ...
        {/* Related Courses */}
        <section className="mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Other Courses at {university.name}</h2>
        ...
        <section className="bg-blue-50 p-4 sm:p-6 md:p-8 rounded-lg text-center">
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Interested in This Program?</h2>
          ...
          <button
            ...
            className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors min-h-[44px] text-sm sm:text-base w-full sm:w-auto shadow-md"
          >
