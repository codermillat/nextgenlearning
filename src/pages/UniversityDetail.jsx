...
import { generateOrganizationSchema, generateBreadcrumbSchema, generateFAQSchema } from '../components/SEO/StructuredData';
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-lg text-gray-600 mb-4">{university.location}</p>
          {university.established && (
            <p className="text-gray-600">Established: {university.established}</p>
          )}
        </section>

        {/* Rankings */}
        <section className="mb-8 bg-gray-50 p-6 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">University Rankings & Accreditation</h2>
        ...
        <section className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold">Programs Offered ({programs.length})</h2>
            <Link
