...
export default function Compare() {
  ...
  const comparisonStructuredData = useMemo(() => {
    const siteUrl = 'https://studyinindiabd.vercel.app';
    
    // WebPage schema
    const webPageSchema = {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Compare Courses & Universities - Side-by-Side Comparison",
      "description": "Compare up to 5 courses or universities side-by-side. Filter by degree level (UG, PG, Diploma, Lateral Entry), university, stream/department. Compare fees, rankings, scholarships, and make informed decisions for your study in India from Bangladesh.",
      "url": `${siteUrl}/compare`,
      "inLanguage": "en-BD",
      "audience": {
      ...
      "about": {
        "@type": "Thing",
        "name": "Course Comparison Tool for Bangladeshi Students"
      }
    };
  ...
  return (
    <>
      <SEOHead
        title="Compare Courses & Universities - Side-by-Side Comparison Tool for Bangladeshi Students | WBE"
        description="Compare up to 5 courses or universities side-by-side. Filter by degree level (UG, PG, Diploma, Lateral Entry), university (Sharda, NIU, CU, Galgotias), stream/department. Compare fees, rankings, scholarships, and make informed decisions for your study in India from Bangladesh. Free comparison tool by Western Bangla Education."
        keywords={[
          'compare courses India',
